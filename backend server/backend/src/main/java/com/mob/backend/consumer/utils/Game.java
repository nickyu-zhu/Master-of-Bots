...
public class Game extends Thread {
    ...
    private void judge(){ //judge the valid
    ...
    private void sendMove(){ //send message to two clients
        lock.lock();
        try {
    ...
    public void run() {
        for(int i = 0; i < 1000; i++){
            if(nextStep()){    // whether go to next step or not
                judge();
